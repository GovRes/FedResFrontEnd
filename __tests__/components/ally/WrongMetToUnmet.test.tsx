...
describe("WrongMetToUnmet", () => {
  ...
  it("renders ally statements and qualifications list", () => {
    ...
    expect(
      screen.getByText(/Our reviewer recommends that you apply for this job/)
    ).toBeInTheDocument();
    expect(
      screen.getByText(/I've reviewed your resume and job description/)
    ).toBeInTheDocument();
  ...
  it('shows different recommendation text when recommendation is "Do not recommend"', () => {
    render(
      <WrongMetToUnmet {...defaultProps} recommendation="Do not recommend" />
    );

    expect(
      screen.getByText(
        /Our reviewer does not recommend that you apply for this job/
      )
    ).toBeInTheDocument();
  });
  ...
  it("applies animation delays to elements", () => {
    ...
    expect(qualificationsList).toHaveStyle({
