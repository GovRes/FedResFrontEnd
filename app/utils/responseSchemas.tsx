...
export const TopicsArraySchema = z.array(Topic);
export const TopicSchema = zodToJsonSchema(Topic);
export const TopicsSchema = zodToJsonSchema(TopicsArraySchema);
export type TopicsType = z.infer<typeof TopicsArraySchema>;
