...
export interface AllyContextType {
  ...
  setQualifications: (value: QualificationsType) => void;
  setRecommendation: (value: string) => void;
  setReviewedMetQualifications: (value: boolean) => void;
  setReviewedUnmetQualifications: (value: boolean) => void;
...
export const AllyProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [step, setStep] = useState<StepType>("user_jobs");
  ...
  const [userJobs, setUserJobs] = useState<UserJobType[]>([
    {
      ...
      gsLevel: "N/A",
      id: "g4v3q8klxy",
      startDate: "04/23/2015",
      organization: "First American Bank",
      title: "System Support Specialist",
      responsibilities:
        "Managing and maintaining software and applications used by the Auto Services line of business. Liaising with vendor support to troubleshoot and fix third-party software issues. Installing server and operating system updates. Monitoring for potential malware or other server attacks. Managing software upgrades. Managing, maintaining and repairing hardware (PCs, printers, and servers) used by the Auto Services line of business. Working with vendors to troubleshoot printer issues. Designing and developing small productivity applications for the business using C# and Access. Interfacing with business partners, providing telephone and face-to-face assistance with their needs.",
    ...
    },
    {
      ...
      gsLevel: "N/A",
      id: "j8u9q5x0jb",
      startDate: "06/22/2008",
      organization: "FirstCare Hospital",
      title: "Tech Support Assistant",
      responsibilities:
        "Providing level 1 and 2 technology phone support. Assessing and redirecting support calls for further assistance. Helping employees with basic computer and software issues. Logging support tickets into the help desk management system. Generating reports from the help desk management system using Crystal Reports and Access.",
      userJobQualifications: [],
    },
  ]);
