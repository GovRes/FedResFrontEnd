...
const technicalRequirements =
  'Additionally, for each specialized experience, generate a random string that is 10 characters long, consisting only of letters and numbers (no special characters and no white space). Assign this string to the "id" attribute on the specialized experience object.';
