...
FOR EVERY KEY PHRASE:
Met Qualifications: 
List all the core skills and experiences the applicant has, based on the analysis, under this heading. Use the name of the position to label each entry, ensuring that the terminology from the key phrases is accurately reflected.
