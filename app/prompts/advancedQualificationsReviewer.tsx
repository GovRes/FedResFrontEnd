...
const technicalRequirements = `Please provide a JSON object that adheres to the following schema: ${JSON.stringify(qualificationsSchema)}, including generating valid UUIDs for all the id fields. For the 'recommendation' field within the "recommendation" object, choose only one of the following values: "Recommend" or "Do not recommend". Do not return both values.`
